...
function load_routes(server) {
    ...
    server.gest('/log/:type', (i, o) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        const password = env_1.env(env_1.__.app_log_password);
        const log_password = i.input('log_password');
        if (!password || log_password !== password) {
            throw new invalid_argument_1.Invalid_argument_external({ log_password: log_password });
        }
